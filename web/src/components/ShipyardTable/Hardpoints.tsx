      ...
      <span className="font-bold text-neutral-400 uppercase text-md">
        ...
        {hardpoints.map((hardpoint: Hardpoint, index: number) => {
          return (
            <div
              key={index}
              className="w-full flex flex-wrap justify-between py-1.5 px-3 bg-neutral-700 mb-1.5"
            >
              <div className="w-1/2 text-sm text-neutral-200 uppercase">{hardpoint.module}</div>
